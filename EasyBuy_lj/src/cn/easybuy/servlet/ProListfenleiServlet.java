...
public class ProListfenleiServlet extends HttpServlet {
          ...
          try {
			...
			try {
          	...
          	if("2".equals(type)){
          		...
          		request.getRequestDispatcher("/Backstage/productClass-modify.jsp").forward(request, response);
