...
import cn.easybuy.service.impl.VipUserServiceimpl;
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println(action);
			...
			try {
				...
				List<VipUser> list = service.SelectUser();
				
				request.setAttribute("list", list);
				request.getRequestDispatcher("/vipXiaofei.jsp").forward(request, response);
