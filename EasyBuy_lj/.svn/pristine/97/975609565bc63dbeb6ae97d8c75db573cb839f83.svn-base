...
<body>
 ...
 <div class="mainCont">
  ...
  <div class="loginBox">
   <div class="loginLeft">
    <img src="<%=path %>/images/login.jpg" width="567" height="348" />
   </div><!--loginLeft/-->
   <div class="loginRight">
   
     <form class="login" action="<%=path%>/servlet/UserinfoServlet?action=login&type=<%=type%>" method="post">
     ...
     <h2>合作伙伴登录：</h2>
     <img src="<%=path %>/images/hezuo.jpg" width="260" height="30" />
    </form><!--login/-->
   </div><!--loginRight/-->
