...
<div id="main" class="wrap">
	<div id="menu-mng" class="lefter">
		<div class="box">
			<dl>
				<dt>用户管理</dt>
				<dd><a href="<%=path %>/servlet/UserinfoServlet?action=adminBack">用户管理</a></dd>
			  <dt>商品信息</dt>
				...
				<dt>新闻管理</dt>
				<dd><em><a href="<%=path %>/Backstage/news-add.jsp">新增</a></em><a href="<%=path %>/Backstage/news-modify.jsp">新闻管理</a></dd>
			</dl>
		</div>
	</div>
	<div class="main">
