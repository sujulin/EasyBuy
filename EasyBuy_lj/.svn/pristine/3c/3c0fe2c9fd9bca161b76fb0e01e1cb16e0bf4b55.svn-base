...
<body>
<%
String loginChenggong=request.getParameter("loginChenggong");

session.setAttribute("loginChenggong", loginChenggong);
 %>
 <div class="hrader" id="header">
  <div class="top">
   <a href="login.jsp" style="color:#C94E13;"><%if(loginChenggong!=null){ %>       <%=loginChenggong %><%} %><%else{ %>请登录<%} %></a> 
   <a href="reg.jsp">注册</a>
   <ul class="topNav">
  ...
  <div class="vipLeft">
   ...
   <dl class="vipNav">
    ...
    <dt class="vip_2">账户设置</dt>
     ...
     <dd><a href="vipPwd.jsp?loginChenggong1=<%=loginChenggong%>">密码修改</a></dd>
