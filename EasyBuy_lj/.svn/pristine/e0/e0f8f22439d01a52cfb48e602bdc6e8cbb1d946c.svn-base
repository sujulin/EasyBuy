		...
		<div class="manage">
			<table class="list">
				...
				<tr>
					...
					<td class="w1 c"><a href="<%=path %>/Backstage/guestbook-modify.jsp">修改</a> <a class="manageDel" href="javascript:void(0)">删除</a></td>
				</tr>
				<tr>
					<td class="first w4 c">1</td>
					<td class="w1 c">张三丰</td>
					<td>北京的货发了没？</td>
					<td class="w1 c"></td>
					<td class="w1 c"><a href="<%=path %>/Backstage/guestbook-modify.jsp">回复</a> <a class="manageDel" href="javascript:void(0)">删除</a></td>
				</tr>
			</table>
			<div class="pager">
				<ul class="clearfix">
