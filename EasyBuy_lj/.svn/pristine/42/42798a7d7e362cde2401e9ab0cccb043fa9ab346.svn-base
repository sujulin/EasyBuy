 ...
 <div class="hrader" id="header">
  <div class="top">
   ...
   <ul class="topNav">
    ...
    <li class="gouwuche"><a href="<%=path %>/servlet/UserinfoServlet?action=userByCar&name=<%=name%>">购物车</a> <strong style="color:#C94E13;">3</strong></li>
...
<li><a href="#" class="lan">中文</a></li>
 ...
 <div class="mid">
  ...
  <a href="<%=path%>/index.jsp"><img src="images/logo.png" width="304" height="74" /></a>
  </h1>
  ...
  <div class="ding-gou">
   <div class="ding">
    <a href="order.jsp"><img src="<%=path %>/images/dingdan.jpg" width="106" height="32" /></a>
   </div><!--ding/-->
   <div class="gou">
    <a href="car.jsp"><img src="<%=path %>/images/gouwuche.jpg" width="126" height="32" /></a>
   </div><!--gou/-->
   <div class="clears"></div>
  </div><!--ding-gou/-->
 </div><!--mid-->
 <div class="navBox navBg3">
  <ul class="nav">
   ...
   <li class="navCur"><a href="<%=path %>/help.jsp">帮助</a></li>
   <div class="clears"></div>
  </ul><!--nav/-->
 </div><!--navBox/-->
 <div class="car">
  <div class="cont">
   <div class="carImg"><img src="<%=path %>/images/car1.jpg" width="951" height="27" /></div>
   <h4 class="orderTitle">收货地址</h4>
   <c:forEach items="${list}" var="item">
      <table class="ord">
    <tr>
     <td width="30%">
      <input type="radio" /> ${item.aName }
     </td>
     <td width="50%">
     ${item.zone },${item.site },${item.zip },${item.phone }
     </td>
     <td>
   ...
   <div class="address">
    ...
    <div class="addList2">
     <input type="image" src="<%=path %>/images/queding.png" width="100" height="32" />
    </div><!--addList2/-->
   </div><!--address/-->
   <table class="orderList">
    ...
    <tr>
     ...
     <td colspan="5" style="text-align:left;color:#930; font-weight:bold;">
      <img src="<%=path %>/images/dianpu.gif" width="20" height="15" style="position:relative;top:2px;" />
    ...
    <tr>
     <td><input type="checkbox" />
      ...
      <dl>
       <dt><a href="<%=path %>/proinfo.jsp"><img src="<%=path %>/images/<%=i.getFilename() %>" width="85" height="85" /></a></dt>
       <dd><!-- 全球最大的中文搜索引擎、致力于让网民更便捷 --> <%=i.getDescription() %><br /><span class="red">有货：</span>从上海出发</dd>
       <div class="clears"></div>
      </dl>
     </td>
     <td><strong class="red"><!-- ￥70.20 --> <%=i.getPrice() %>	</strong></td>
     ...
     <td>
     <%=Integer.parseInt(i.getPrice())*goods.get(i) %>
     <strong class="red">
      
     <td><a href="#" class="green">收藏</a><br />
     
     <a href="<%=path %>/servlet/PhoneInfoServlet?action=delete&id=<%=i.getPid()%>" onclick="delcfm();" class="green">删除</a>	
     </strong></td>
   ...
   <!--  <tr>
    ...
    <tr>
     ...
     <td>
      <dl>
       <dt><a href="proinfo.jsp"><img src="images/phone.png" width="85" height="85" /></a></dt>
   ...
   <div class="zongji">
    ...
    <strong>总计(不含运费)：</strong><strong class="red"><!-- ￥70.42 --> <%=cart.getTotalPrice() %></strong>
   </div><!--zongji/-->
    <%
   }
    %>
   <div class="jiesuan">
    <a href="<%=path %>/index.jsp" class="jie_1">继续购物&gt;&gt;</a>
    <a href="<%=path %>/order.jsp" class="jie_2">立即结算&gt;&gt;</a>
    <div class="clears"></div>
   </div><!--jiesuan/-->
   <div class="clears"></div>
  </div><!--cont/-->
