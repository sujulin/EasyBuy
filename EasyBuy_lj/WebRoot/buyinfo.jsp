...
String name=request.getParameter("name");
 ...
 <script type="text/javascript">
     ...
     var result=confirm("没有登录，不能添加购物车，是否转到登录页面？");
     if(result){
       var path = "<%=path%>/login.jsp?type=0";
         location.href=path; 
         }
      }else{
   
         var num =  document.getElementById("number").value; 
          var path = "<%=path%>/servlet/PhoneInfoServlet?id="+id+"&num="+num+"&action=add&name=<%=name %>";
         location.href=path; 
      }
      }
      function add()
...
<body>
 <div class="hrader" id="header">
  <div class="top">
   <a href="login.jsp" style="color:#C94E13;"><%if(name!=null){ %>       <%=name %><%} %><%else{ %>请登录<%} %></a> 
   <a href="reg.jsp">注册</a>
   <ul class="topNav">
     <li><a href="order.jsp">我的订单 </a></li>
    <li class="gouwuche"><a href="<%=path %>/servlet/UserinfoServlet?action=userByCar&name=<%=name%>">购物车</a> <p style="color:#C94E13;"><!-- <input type="text" id="number" name="number" class="text" value="1" size="2"/> --></p></li>
 ...
 <div class="navBox navBg1">
  <ul class="nav">
   ...
   <div class="clears"></div>
          ...
          <% 
             PhoneInfoDaoimpl itemDao = new PhoneInfoDaoimpl();
             Phoneinfo item = itemDao.getItemsById(Integer.parseInt(request.getParameter("id")));
 ...
 <div class="buyinfo">
  <div class="buyDtl">
   <div class="buyDtlLeft">
    <div class="buyimgBig">
     <img src="images/<%=item.getFilename() %>" width="360" height="360" />
    ...
    <ul class="buyimgsmall">
     <li><img src="images/<%=item.getFilename() %>" width="50" height="50" /></li>
 ...
 <!--  <h4>【赠送精品蓝牙耳机+超大容量移动电源】5.0英寸高清大屏 真八核1.7GHz 1300万像素主摄像头</h4>  -->
    ...
    <h5>价格：<span>￥</span><strong id="price_item_1"> 
    <%=item.getPrice() %> 
    </strong></h5>
      ...
      <td>
       <div class="p_number">
		<div class="f_l add_chose">
			 ...
			 <a id="sub" class="reduce" onclick="sub();">-</a>
			<input type="text" id="number" name="number" class="text" value="1" size="2"/>
			<a id="add" class="add" onclick="add();">+</a>
...
<!-- <div class="f_l add_chose">
		...
		<div class="f_l buy">
			单价：<span class="total-font" > <%=item.getPrice() %> <%-- <%=Integer.parseInt(item.getPrice())*goods.get(i) %> --%></span>
    ...
    <div class="goumai">
     <a href="success.jsp" class="buy-gou">立即购买</a>
     <a href="javascript:selflog_show(<%=item.getPid()%>)">加入购物车</a>
