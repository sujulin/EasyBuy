<%@page import="cn.easybuy.entity.ProListfenji"%>
...
function findByName(nam){
	...
	<%-- var path="<%=path%>/servlet/ProlistinfoServlet?action=findByPrice;
	location.href=path; --%>
}
...
<body>
 ...
 String name=request.getParameter("name");
  %>
   <a href="<%=path%>/login.jsp" style="color:#C94E13;"><%if(name!=null){ %>  <%=name %><%} %><%else{ %>请登录<%} %></a> 
   ...
   <ul class="topNav">
    ...
    <li class="shoucangjia"><a href="<%=path%>/shoucang.jsp">收藏夹</a></li>
 ...
 <div class="mid">
  ...
  <form action="#" method="get" class="subBox">
   <div class="subBox2">
    <input type="text" class="subText" name="nam" />
    <input type="image" src="<%=path%>/servlet/ProlistinfoServlet?action=find&name=nam" width="95" height="32" class="subImg" />
    <div class="hotci">
    <a href="#">酷派大神</a>
    <a href="#">三星s5</a>
    <a href="#">诺基亚1020</a>
 ...
 <div class="navBox navBg1">
  <ul class="nav">
   ...
   <li><a href="<%=path%>/sell.jsp">卖家</a></li>
    	...
    	<div class="item" id="nav"><a href="#" class="nav">全部商品分类</a>
        	<div class="nav_son">
            	<ul>
                	...
                	<%--  <%
                	List<ProListfenji>menus1=(List<ProListfenji>)request.getAttribute("menus1");
                	for(ProListfenji item:menus1){
                	 %>
      
                	 <li class="li01" ><a href="#" onmouseover="javascript:update(<%=item.getId() %>)"><%=item.getName()%></a></li>
                	 <%}%>  --%>
                   <c:forEach items="${menus1}" var="menus1" varStatus="status">
                   <li class="li01"><a href="#">${menus1.name}</a></li>
                ...
                <div class="hover">
	                ...
	                <c:forEach items="${menus1}" var="menus1">
	                	<c:forEach items="${set1 }" var="set1">
	                		<c:choose>
	                			<c:when test="${menus1.id==set1}">
	                				<div id="son">
	                					<c:forEach items="${map1.get(set1)}" var="map1">
		                					<dl>
		                   						 <dt><a href="<%=path %>/servlet/ProlistinfoServlet?action=find&name=${map1.name}">${map1.name}</a></dt> 
		                   						<dd>  <a href="#">全部${map1.name}</a> 
		                   							<c:forEach items="${set2}" var="set2">
		                   								<c:choose>
		                   									<c:when test="${map1.id==set2}">
		                   										<c:forEach items="${map2.get(set2)}" var="map2">
		                   											<a href="<%=path %>/servlet/ProlistinfoServlet?action=find&name=${map2.name}" class="red">${map2.name}</a>
		                   										</c:forEach>
		                   									</c:when>
		                   								</c:choose>
		                   							</c:forEach>
   	  ...
   	  <div class="item"><a href="<%=path %>/HTML/index.jsp" class="home">商城首页</a></div>
 ...
 <form action="#" method="get" class="proDingzhi">
  <img src="<%=path%>/images/dingzhi.jpg" width="972" height="167" />
...
<script>window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"","bdMini":"2","bdMiniList":false,"bdPic":"","bdStyle":"0","bdSize":"24"},"share":{}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];</script>
   ...
   <tr>
    ...
    <td>
     <div class="proPosition">
      ...
      <input type="image" src="<%=path%>/images/queding.png" class="queen2" />
      <div class="more-shou">
       <span class="more">
        更多 &gt;
       </span>
    ...
    <td>
     <div class="proPosition">
      ...
      <div class="jiage">
       ...
       <input type="image" src="<%=path%>/images/queding.png" class="queen"/>
      </div><!--jiage/-->
     </div>
    </td>
   </tr>
      ...
      <li>
       ...
       <div class="chilXuan">
        <div class="chilXBox">
         ...
         <input type="<%=path%>image" src="images/queding.png" class="queen2" />
        </div><!--chilXBox-->
       </div><!--chilXuan/-->
      </li>
      <li>
  ...
  <%
          List<Prolist> list4=(List<Prolist>)request.getAttribute("list4");
          for(Prolist item:list4){
          
           %>
  
   <dl>
   <dt><a href="<%=path %>/buyinfo.jsp?id=<%=item.getPid() %>&name=<%=name %>"><img src="<%=path%>/images/<%=item.getPimage() %>" /></a></dt>
    <dd>
    <h3>￥<%=item.getPprice() %></h3>
     <div class="phonePars">
     <%=item.getPname() %>
     </div><!--phonePar/-->
     <div class="xiaoliang">
   ...
   <%
     ...
     %> 
 <%--  <!--  <dl>
    <dt><a href="buyinfo.jsp"><img src="<%=path%>/images/phone4.png" /></a></dt>
    <dd>
     <h3>￥4800.00</h3>
     <div class="phonePars">
   ...
   <dl>
    <dt><a href="buyinfo.jsp"><img src="<%=path%>/images/phone3.png" /></a></dt>
    <dd>
     <h3>￥4800.00</h3>
     <div class="phonePars">
      Apple 苹果 iPhone 5s 16G TD-LTE/TD-SCDMA/WCDMA/GSM 4G手机 金
   ...
   <dl>
    <dt><a href="buyinfo.jsp"><img src="<%=path%>/images/phone2.png" /></a></dt>
    <dd>
     <h3>￥4800.00</h3>
     <div class="phonePars">
      Apple 苹果 iPhone 5s 16G TD-LTE/TD-SCDMA/WCDMA/GSM 4G手机 金
   ...
   <dl>
    <dt><a href="buyinfo.jsp"><img src="<%=path%>/images/phone1.png" /></a></dt>
    <dd>
     <h3>￥4800.00</h3>
     <div class="phonePars">
      Apple 苹果 iPhone 5s 16G TD-LTE/TD-SCDMA/WCDMA/GSM 4G手机 金
   ...
   <dl>
    <dt><a href="buyinfo.jsp"><img src="<%=path%>/images/phone5.png" /></a></dt>
    <dd>
     <h3>￥4800.00</h3>
     <div class="phonePars">
      Apple 苹果 iPhone 5s 16G TD-LTE/TD-SCDMA/WCDMA/GSM 4G手机 金
 ...
 <div class="footBox">
  <div class="footers">
   <div class="footersLeft">
    <a href="index.jsp"><img src="<%=path %>/images/ftlogo.jpg" width="240" height="64" /></a>
