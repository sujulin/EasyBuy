 ...
 <div class="vipBox">
  <div class="vipLeft">
   ...
   <dl class="vipNav">
    ...
    <dt class="vip_3">客户服务</dt>
     <dd class="ddCur"><a href="vipQuxiao.jsp">取消订单/退货</a></dd>
  ...
  <div class="vipRight">
   ...
   <table class="vipQuxiao">
    ...
    <tr>
     <td><%=i.getNumber() %></td>
     <td><img src="images/<%=i.getFilename() %>" width="60" height="55"></td>
     <td>unique</td>
     <td class="red"> <%=Integer.parseInt(i.getPrice())*goods.get(i) %></td>
     <td class="green"> <%=Integer.parseInt(i.getPrice())*goods.get(i) %></td>
