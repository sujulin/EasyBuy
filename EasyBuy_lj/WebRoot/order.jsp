  ...
  <table class="orderList">
    ...
    <tr>
     <td><input type="checkbox" />
      ...
      <dl>
       <dt><a href="<%=path %>/proinfo.jsp"><img src="<%=path %>/images/phone.png" width="85" height="85" /></a></dt>
   ...
   <table class="zongjia" align="right">
    <tr>
     ...
     <td width="60"><strong class="red"><%=cart.getTotalPrice() %></strong></td>
    </tr>
    <tr>
    ...
    <tr>
     ...
     <td><strong class="red"><%=cart.getTotalPrice() %></strong></td>
    </tr>
    <tr>
