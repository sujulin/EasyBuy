		...
		<div class="manage">
			<table class="list">
				...
				<tr>
					...
					<td class="thumb"><img src="<%=path %>/Backstage/images/product/0_tiny.gif" /><a href="<%=path %>/Backstage/product-view.html" target="_self">铁三角 Audio-Technica ATH-EQ300M-SV 银色 挂耳式耳机</a></td>
					<td class="w1 c"><a href="<%=path %>/Backstage/product-modify.jsp">修改</a> <a class="manageDel" href="javascript:void(0)">删除</a></td>
				</tr>
				<tr>
					<td class="first w4 c">1</td>
					<td class="thumb"><img src=".<%=path %>/Backstage/images/product/0_tiny.gif" /><a href="<%=path %>/Backstage/product-view.html" target="_self">铁三角 Audio-Technica ATH-EQ300M-SV 银色 挂耳式耳机</a></td>
